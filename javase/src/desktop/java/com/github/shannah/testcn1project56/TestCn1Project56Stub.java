...
package com.github.shannah.testcn1project56;
 ...
 * @author Shai Almog
 */
public class TestCn1Project56Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Test Cn1 Project 56";
    private static final String APP_NAME = "test-cn1-project-56";
    ...
    private TestCn1Project56 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestCn1Project56Stub());
    }
